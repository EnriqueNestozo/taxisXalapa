                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <input class="form-control" name="password_confirmation" id="input-password-confirmation" type="password" placeholder="{{ __('Confirma nueva contraseña') }}" value="" required />
                    </div>
                  </div>
                </div>
              </div>
